    ...
    <div class="card-body">
      <div class="accordion" id="accordionPanelsStayOpenExample">
              ...
              <div class="tangible-question">
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="tangibleQuestion1"
                ...
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="tangibleQuestion2"
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse"
              data-bs-target="#accordion-reliability" aria-expanded="true" aria-controls="accordion-reliability">
              Reliability
            </button>
          </h2>
          <div id="accordion-reliability" class="accordion-collapse collapse show">
            <div class="accordion-body">
              <div class="reliability-question">
                <div class="form-group question-group mb-3">
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="reliabilityQuestion1"
                ...
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="reliabilityQuestion2"
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse"
              data-bs-target="#accordion-responsiveness" aria-expanded="true" aria-controls="accordion-responsiveness">
              Responsiveness
            </button>
          </h2>
            ...
            <div class="accordion-body">
              <div class="responsiveness-question">
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="responsivenessQuestion1"
                ...
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="responsivenessQuestion2"
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-empathy"
            ...
            <div class="accordion-body">
              <div class="empathy-question">
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="empathyQuestion1"
                ...
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="empathyQuestion2"
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse"
              data-bs-target="#accordion-assurance" aria-expanded="true" aria-controls="accordion-assurance">
              Assurance
            </button>
          </h2>
            ...
            <div class="accordion-body">
              <div class="assurance-question">
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="assuranceQuestion1"
                ...
                <div class="form-group question-group mb-3">
                  ...
                  <div class="input-group gap-3">
                    <input type="text" class="form-control" value="Apakah kamu hooman?" id="assuranceQuestion2"
